...
import { canvasWidgetNameForDocument, mcpAppWidgetNameForToolCall } from "./widget-names.ts";
import {
...
export { canvasWidgetNameForDocument, mcpAppWidgetNameForToolCall } from "./widget-names.ts";
