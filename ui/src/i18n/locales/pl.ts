...
export const pl: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Nie usunięto żadnej zapisanej sesji WhatsApp. Może już jej nie być lub jej katalog uwierzytelniania wymaga ręcznego wyczyszczenia.",
    },
  ...
  configView: {
    ...
    sidebarPrefs: {
      title: "Pasek boczny",
      hint: "Wybierz, co ma być widoczne podczas działających sesji.",
  ...
  custodian: {
    ...
    exitSetup: "Wyjdź z konfiguracji",
    newAgent: "Nowy agent",
  ...
  mcpPage: {
    connectorsLink: "Odkryj konektory z obsługą jednym kliknięciem na stronie Plugins.",
    servers: "Serwery",
    oauth: "OAuth",
    filtered: "Filtrowane",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Pozwól agentom łączyć narzędzia w kompaktowych, izolowanych przepływach pracy w JavaScript.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Czatuj, rozmawiaj, zatwierdzaj akcje i udostępniaj do OpenClaw z iOS.",
      },
      android: {
        title: "Android",
  ...
  board: {
    ...
    actionFailed: "Nie można zapisać zmiany panelu.",
    ...
    widget: {
      cellLabel:
        "Widżet panelu: {title}. Użyj klawiszy strzałek do nawigacji. Przytrzymaj Alt i naciśnij klawisz strzałki, aby go przenieść.",
  ...
  chat: {
    ...
    board: {
      ...
      resizeDock: "Zmień rozmiar panelu czatu",
    ...
    modelControls: {
      ...
      usingDefault: "Używanie domyślnych ustawień z Ustawień",
    ...
    composer: {
      ...
      dictationDisconnected: "Dyktowanie zatrzymane z powodu rozłączenia Gateway.",
