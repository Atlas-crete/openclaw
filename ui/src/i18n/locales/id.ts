...
export const id: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "Keluar.",
      logoutNotCleared:
        "Tidak ada sesi WhatsApp tersimpan yang dihapus. Sesi mungkin sudah tidak ada, atau direktori auth-nya mungkin memerlukan pembersihan manual.",
    },
  ...
  custodian: {
    ...
    history: {
      ...
      invalidEdit: "Suntingan manual ini tidak lulus validasi konfigurasi.",
    ...
    nudge: {
      configReload: "Pemuatan ulang konfigurasi berhenti — tanyakan saya apa yang terjadi",
      channelAuth: "Autentikasi {channel} menurun — tanyakan saya apa yang terjadi",
      channelDisconnected: "{channel} baru saja terputus — tanyakan saya apa yang terjadi",
  ...
  labsPage: {
    ...
    sectionDescription: "Perubahan tersimpan langsung dan berlaku untuk proses agen berikutnya.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplikasi pendamping untuk ponsel, jam, desktop, dan peramban Anda — plus plugin untuk memperluas kemampuan agen Anda.",
  ...
  board: {
    ...
    widget: {
      ...
      errorDetail: "Masalah ini hanya terbatas pada kartu ini.",
  ...
  chat: {
    ...
    messages: {
      ...
      hide: "Sembunyikan",
      hideConfirm: "Sembunyikan pesan ini di peramban ini? Agen masih dapat melihatnya.",
      hideMessage: "Sembunyikan pesan",
      hideTooltip: "Sembunyikan hanya di peramban ini",
    ...
    composer: {
      ...
      dictationAudioUnsupported: "Gateway menampilkan format audio dikte yang tidak didukung.",
