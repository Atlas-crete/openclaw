...
export const vi: TranslationMap = {
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint:
        "JPEG, PNG hoặc WebP. Hình ảnh được cắt ở giữa và thay đổi kích thước thành 512px.",
  ...
  subtitles: {
    ...
    notifications: "Thông báo đẩy của trình duyệt từ gateway của bạn.",
  ...
  custodian: {
    ...
    newAgent: "Agent mới",
    hatchDraft: "Dậy nào, bạn của tôi!",
    ...
    history: {
      ...
      description: "Những gì đã thay đổi trên hệ thống này, mới nhất lên đầu.",
  ...
  mcpServers: {
    ...
    adminRequired: "Việc thay đổi máy chủ MCP cần quyền operator.admin.",
    enable: "Bật",
    disable: "Tắt",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Cho phép các agent kết hợp công cụ trong quy trình JavaScript gọn nhẹ, được cách ly.",
    },
    swarm: {
      title: "Swarm",
      description: "Cho phép Code Mode điều phối các nhóm subagent song song.",
      empty: "Không có swarm nào đang hoạt động.",
      defaultPhase: "Không phân giai đoạn",
    },
  },
  aboutPage: {
  ...
  appsPage: {
    ...
    heroTagline:
      "Các ứng dụng đồng hành cho điện thoại, đồng hồ, máy tính và trình duyệt của bạn — cùng các plugin để mở rộng khả năng của agent.",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Trò chuyện dễ nhìn và trả lời nhanh ngay trên cổ tay của bạn.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Ứng dụng đồng hành Android mở rộng OpenClaw ra đồng hồ của bạn.",
      },
      macos: {
        title: "macOS",
  ...
  board: {
    ...
    emptyHint: "Agent của bạn có thể ghim tiện ích tại đây — thử yêu cầu một thẻ trạng thái.",
    ...
    widget: {
      cellLabel:
        "Widget bảng điều khiển: {title}. Dùng các phím mũi tên để điều hướng. Giữ Alt và nhấn phím mũi tên để di chuyển.",
      ...
      rejectedDetail: "Widget này không hoạt động cho đến khi được gỡ bỏ hoặc thay thế.",
  ...
  chat: {
    ...
    board: {
      ...
      dockMenu: "Dock trò chuyện: {dock}",
      dockLeft: "Neo trò chuyện bên trái",
      dockRight: "Neo trò chuyện bên phải",
      dockBottom: "Neo chat xuống dưới",
      dockHidden: "Ẩn chat",
      resizeDock: "Thay đổi kích thước khay chat",
      ...
      resetDescription:
        "Bối cảnh cuộc trò chuyện sẽ đặt lại. Bảng điều khiển của bạn vẫn giữ nguyên.",
    },
    catalog: {
    ...
    composer: {
      ...
      dictationDisconnected: "Đọc chính tả đã dừng vì Gateway ngắt kết nối.",
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess: "Cần quyền ghi của người điều hành để mở cuộc thảo luận này.",
