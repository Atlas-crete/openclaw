...
export const nl: TranslationMap = {
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivity: "Live agentactiviteit tonen in zijbalk",
  ...
  execApproval: {
    ...
    otherPending: "Andere lopende verzoeken",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelDegraded: "{channel} functioneert verminderd — vraag me wat er is gebeurd",
  ...
  labsPage: {
    ...
    swarm: {
      title: "Swarm",
      description: "Laat Codemodus groepen subagents parallel orkestreren.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      wearOs: {
        title: "Wear OS",
        desc: "De Android-companion brengt OpenClaw naar je horloge.",
      },
      macos: {
        title: "macOS",
  ...
  board: {
    ...
    widget: {
      ...
      appStaleDetail:
        "De server, resource of het oorspronkelijke transcript is niet langer beschikbaar.",
      retry: "Opnieuw proberen",
  ...
  chat: {
    ...
    board: {
      ...
      defaultTab: "Hoofd",
      mockPlaceholder: "Bordweergave-seam · {tabs} tabbladen · {widgets} widgets",
