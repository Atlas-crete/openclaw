...
export const ja_JP: TranslationMap = {
  ...
  subtitles: {
    ...
    apps: "スマホ、時計、デスクトップ、ブラウザ向けのコンパニオンアプリ。",
  ...
  custodian: {
    ...
    sessionRestarted:
      "{error} OpenClaw は新しいセッションを開始しました。以前のメッセージはコンテキストとして残っています。",
  ...
  mcpServers: {
    ...
    nameInvalid: "サーバー名には、文字、数字、ドット、ダッシュ、アンダースコアを使用できます。",
    targetInvalid:
  ...
  labsPage: {
    intro:
      "Labsには、リリース間で変更、破損、または削除される可能性のある実験的な機能が含まれています。",
    sectionTitle: "実験的な機能",
  ...
  appsPage: {
    ...
    cards: {
      ...
      wearOs: {
        title: "Wear OS",
        desc: "Android コンパニオンは OpenClaw をあなたの時計に拡張します。",
      },
      macos: {
        title: "macOS",
  ...
  profilePage: {
    ...
    identity: {
      ...
      loading: "あなたの識別情報を読み込み中…",
      profileUnavailable: "あなたの識別プロフィールを読み込めませんでした。",
      avatar: "アバター",
      avatarDescription: "PNG、JPEG、または WebP。画像は 256 × 256 以下にリサイズされます。",
      chooseAvatar: "画像を選択",
      processingAvatar: "処理中…",
      displayName: "表示名",
      displayNameDescription: "このゲートウェイを使用している他の人に表示されます。",
      ...
      avatarErrors: {
        ...
        tooLarge: "処理されたアバターは512 KBを超えています。",
      },
    },
  },
  tasksPage: {
  ...
  board: {
    ...
    emptyTitle: "作業の準備が整った、すっきりとしたボード",
    emptyHint:
    ...
    announcement: {
      ...
      granted: "ウィジェットのアクセスが許可されました。",
      rejected: "ウィジェットのアクセスが拒否されました。",
    },
    widget: {
      cellLabel:
      ...
      appStaleDetail:
        "そのサーバー、リソース、または元のトランスクリプトが利用できなくなりました。",
      retry: "再試行",
      frameResolverMissing: "ウィジェットのコンテンツは利用できません。",
      frameAuthorizationFailed: "更新を繰り返した後もウィジェットの認証に失敗しました。",
  ...
  chat: {
    ...
    composer: {
      ...
      dictationReleaseToInsert: "離すと音声入力を挿入",
