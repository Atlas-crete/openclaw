...
export const uk: TranslationMap = {
  ...
  sessionsView: {
    ...
    viewArchived: "Переглянути архів",
    sessionArchived: "Гілку заархівовано",
    sessionsArchived: "Заархівовано {count} гілок",
    deleteAllArchived: "Видалити всі заархівовані…",
    deleteAllArchivedConfirm: "Видалити {count} заархівованих гілок та їхні транскрипти?",
  ...
  configView: {
    ...
    sidebarPrefs: {
      title: "Бічна панель",
      hint: "Виберіть, що відображати під час виконання сеансів.",
  ...
  subtitles: {
    ...
    security: "Автентифікація Gateway, політика виконання, профіль інструментів та підтвердження.",
  ...
  custodian: {
    ...
    history: {
      ...
      invalidEdit: "Ця ручна правка не пройшла перевірку конфігурації.",
    ...
    nudge: {
      ...
      channelDegraded: "{channel} працює зі збоями — запитайте мене, що сталося",
  ...
  mcpServers: {
    ...
    nameTaken: "Сервер MCP з іменем «{name}» вже існує.",
    ...
    adminRequired: "Зміни MCP-сервера потребують доступу operator.admin.",
    enable: "Увімкніть",
    disable: "Вимкнути",
  ...
  mcpPage: {
    connectorsLink: "Знайдіть конектори з підключенням одним кліком на сторінці Plugins.",
    servers: "Сервери",
    oauth: "OAuth",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Дозволяє агентам поєднувати інструменти в компактні, ізольовані робочі процеси JavaScript.",
    },
    swarm: {
      title: "Swarm",
      description: "Дозволяє Code Mode керувати групами субагентів паралельно.",
  ...
  appsPage: {
    ...
    badgeBundledIos: "Входить до застосунку iOS",
    badgeBundledAndroid: "Входить до застосунку Android",
    ...
    cards: {
      ...
      linux: {
        title: "Linux",
        desc: "Нативний застосунок для робочого столу — збірки .deb і AppImage.",
      },
      chrome: {
  ...
  chat: {
    ...
    composer: {
      ...
      dictationFinalizationTimedOut:
        "Диктування зупинено, перш ніж вдалося завершити останній частковий транскрипт.",
      dictationProviderUnavailable: "Не налаштовано постачальника транскрипції для диктування.",
