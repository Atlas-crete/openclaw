...
export const ko: TranslationMap = {
  ...
  custodian: {
    ...
    sessionRestarted:
      "{error} OpenClaw가 새 세션을 시작했습니다. 이전 메시지는 참고용으로 유지됩니다.",
  ...
  labsPage: {
    intro:
      "Labs에는 릴리스마다 변경되거나, 작동하지 않거나, 사라질 수 있는 실험적 기능이 포함되어 있습니다.",
    sectionTitle: "실험적 기능",
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "에이전트가 컴팩트하고 샌드박스화된 JavaScript 워크플로에서 도구를 조합할 수 있게 합니다.",
    },
    swarm: {
      title: "Swarm",
      description: "Code Mode가 서브에이전트 그룹을 병렬로 오케스트레이션할 수 있게 합니다.",
  ...
  profilePage: {
    ...
    identity: {
      ...
      loading: "내 신원 로드 중…",
      profileUnavailable: "내 신원 프로필을 불러올 수 없습니다.",
      avatar: "아바타",
  ...
  board: {
    ...
    widget: {
      ...
      frameAuthorizationFailed: "여러 번 새로 고침을 시도했지만 위젯 인증에 실패했습니다.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "분기 전환에는 운영자 관리 권한이 필요합니다.",
    ...
    messages: {
      ...
      hide: "숨기기",
      hideConfirm:
        "이 브라우저에서 이 메시지를 숨길까요? 에이전트는 여전히 이 메시지를 볼 수 있습니다.",
      hideMessage: "메시지 숨기기",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "작성창의 마이크 버튼을 누른 채 말한 다음, 놓으면 전송하지 않고 텍스트가 삽입됩니다.",
