...
export const fa: TranslationMap = {
  ...
  quickSettings: {
    ...
    personal: {
      ...
      avatarTooLarge: "آواتار پردازش‌شده هنوز هم بیش از حد بزرگ است.",
  ...
  custodian: {
    ...
    sessionRestarted:
      "{error} OpenClaw یک جلسه جدید آغاز کرد؛ پیام‌های پیشین برای زمینه باقی می‌مانند.",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "به عامل‌ها اجازه دهید ابزارها را در گردش‌کارهای فشرده و ایزوله JavaScript ترکیب کنند.",
    },
    swarm: {
      title: "Swarm",
      description: "به Code Mode اجازه دهید گروه‌هایی از زیرعامل‌ها را به‌صورت موازی هماهنگ کند.",
      empty: "هیچ swarm فعالی نیست.",
  ...
  appsPage: {
    heroTitle: "OpenClaw را همه‌جا ببرید",
    heroTagline:
      "اپ‌های همراه برای گوشی، ساعت، دسکتاپ و مرورگر شما — به‌همراه پلاگین‌هایی برای گسترش کارهایی که عامل شما می‌تواند انجام دهد.",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "از iOS چت کنید، صحبت کنید، اقدامات را تأیید کنید و به OpenClaw به اشتراک بگذارید.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "چت‌های سریع و پاسخ‌های فوری از روی مچ شما.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      chrome: {
        title: "افزونه Chrome",
        desc: "به OpenClaw اجازه دهید Chrome موجود شما را کنترل کند — برگه‌ها، صفحه‌ها و فرم‌ها.",
      },
      plugins: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      linkedEmails: "ایمیل‌های متصل‌شده",
  ...
  board: {
    ...
    widget: {
      ...
      appStaleTitle: "این برنامه سنجاق‌شده منقضی شده است",
      appStaleDetail: "سرور، منبع یا رونوشت مبدأ آن دیگر در دسترس نیست.",
      retry: "تلاش مجدد",
      frameResolverMissing: "محتوای ابزارک در دسترس نیست.",
      frameAuthorizationFailed: "پس از تلاش‌های مکرر برای بازخوانی، احراز هویت ابزارک ناموفق بود.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable: "تعویض شاخه هنگام کار کردن عامل در دسترس نیست.",
    ...
    board: {
      ...
      dockMenu: "پهلوگیری گفتگو: {dock}",
      dockLeft: "پهلوگیری گفتگو در چپ",
      dockRight: "پهلوگیری گفتگو در راست",
      dockBottom: "پهلوگیری گفتگو در پایین",
    ...
    questions: {
      ...
      answeredElsewhere: "در جای دیگر پاسخ داده‌شده",
      unavailable: "در دسترس نیست",
      expired: "منقضی‌شده",
      cancelled: "لغوشده",
    },
    messages: {
      ...
      rewindUnavailable: "بازگشت در حالی که عامل مشغول کار است در دسترس نیست",
      forkUnavailable: "انشعاب در حالی که عامل مشغول کار است در دسترس نیست",
    ...
    composer: {
      ...
      cameraPageInactive: "وقتی این صفحه غیرفعال است، دوربین‌ها در دسترس نیستند.",
      ...
      holdToRecordSettingDescription:
        "دکمه میکروفون نویسه‌گر را نگه دارید، صحبت کنید، سپس رها کنید تا متن بدون ارسال درج شود.",
      ...
      dictationFinalizing: "در حال پایان دادن دیکته…",
      dictationFinalizationTimedOut: "دیکته پیش از نهایی شدن آخرین رونوشت جزئی متوقف شد.",
      dictationProviderUnavailable: "هیچ ارائه‌دهنده رونویسی‌ای برای دیکته پیکربندی نشده است.",
