...
export const tr: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Kayıtlı hiçbir WhatsApp oturumu temizlenmedi. Zaten mevcut olmayabilir veya kimlik doğrulama dizininin elle temizlenmesi gerekebilir.",
    },
  ...
  quickSettings: {
    ...
    personal: {
      ...
      uploading: "İşleniyor…",
      profileHint:
        "JPEG, PNG veya WebP. Görüntüler ortadan kırpılır ve 512px boyutuna yeniden boyutlandırılır.",
  ...
  custodian: {
    ...
    history: {
      ...
      description: "Bu sistemde neler değişti, en yeniden en eskiye.",
      ...
      invalidEdit: "Bu manuel düzenleme yapılandırma doğrulamasını geçmedi.",
      opaqueChange:
    ...
    nudge: {
      ...
      channelDisconnected: "{channel} az önce bağlantısı kesildi — ne olduğunu sor",
      channelDegraded: "{channel} sorunlu durumda — ne olduğunu sor",
  ...
  labsPage: {
    ...
    restartRequired: "Gateway yeniden başlatılması gerekir.",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "iOS üzerinden sohbet edin, konuşun, işlemleri onaylayın ve OpenClaw'a paylaşın.",
      },
      android: {
        title: "Android",
      ...
      plugins: {
        ...
        desc: "OpenClaw'u topluluktan kanallar, araçlar ve Skills ile genişletin.",
      },
    },
  },
  presence: {
  ...
  board: {
    ...
    emptyHint: "Ajanınız buraya widget sabitleyebilir — bir durum kartı istemeyi deneyin.",
    ...
    widget: {
      ...
      rejectedDetail: "Bu widget kaldırılana veya değiştirilene kadar etkin kalmaz.",
  ...
  chat: {
    ...
    board: {
      ...
      dockLeft: "Sohbeti sola yasla",
      dockRight: "Sohbeti sağa yasla",
      dockBottom: "Sohbeti alta yasla",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Besteci mikrofon düğmesini basılı tutun, konuşun, ardından göndermeden metin eklemek için bırakın.",
      ...
      dictationFinalizationTimedOut: "Dikte, son kısmi transkript tamamlanamadan durdu.",
