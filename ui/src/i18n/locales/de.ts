...
export const de: TranslationMap = {
  ...
  configView: {
    ...
    syncedHint: "Über das Gateway auf all deinen Geräten synchronisiert.",
    notifications: {
      ...
      nativeBlockedHint:
        "Benachrichtigungen für OpenClaw sind in macOS deaktiviert. Erlaube sie unter Systemeinstellungen > Mitteilungen.",
    },
    appearance: {
      theme: "Design",
    ...
    sidebarPrefs: {
      ...
      liveActivityHint:
        "Zeige die neueste Assistenten- oder Tool-Aktivität unterhalb laufender Sitzungen an.",
    },
    connection: {
      title: "Verbindung",
      gateway: "Gateway",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelAuth: "{channel}-Authentifizierung eingeschränkt — frag mich, was passiert ist",
  ...
  labsPage: {
    intro:
      "Labs enthält experimentelle Funktionen, die sich zwischen Releases ändern, kaputtgehen oder verschwinden können.",
    sectionTitle: "Experimentelle Funktionen",
    sectionDescription:
      "Änderungen werden sofort gespeichert und gelten für zukünftige Agenten-Läufe.",
  ...
  appsPage: {
    ...
    sectionMobile: "Auf deinem Telefon",
    havePhone: "Hast du die App schon?",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chatte, sprich, genehmige Aktionen und teile aus iOS in OpenClaw.",
      },
      android: {
        title: "Android",
  ...
  board: {
    ...
    emptyHint: "Dein Agent kann hier Widgets anheften – frage einfach nach einer Statuskarte.",
    ...
    widget: {
      ...
      appStaleDetail:
        "Der zugehörige Server, die Ressource oder das ursprüngliche Transkript ist nicht mehr verfügbar.",
      retry: "Erneut versuchen",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable:
        "Der Wechsel der Verzweigung ist nicht möglich, während der Agent arbeitet.",
      branchSwitchRequiresAdmin: "Der Wechsel der Verzweigung erfordert Operator-Admin-Zugriff.",
    ...
    board: {
      ...
      resetDescription:
        "Der Konversationskontext wird zurückgesetzt. Dein Dashboard bleibt erhalten.",
    },
    catalog: {
      remoteViewOnly:
    ...
    composer: {
      ...
      microphoneAppliesNextSession:
        "Änderungen werden mit dem Start deiner nächsten Talk-Sitzung wirksam.",
      ...
      holdToRecordSetting: "Mikrofon-Taste zum Diktieren gedrückt halten",
      holdToRecordSettingDescription:
        "Halte die Mikrofon-Taste im Editor gedrückt, sprich und lasse dann los, um Text einzufügen, ohne ihn zu senden.",
      ...
      dictationBrowserAudioUnsupported:
        "Dieser Browser kann Diktier-Audio nicht mit 8 kHz aufnehmen.",
      dictationConnecting: "Diktat wird gestartet…",
      dictationDisconnected: "Diktat wurde beendet, weil das Gateway die Verbindung getrennt hat.",
      dictationFailed: "Diktat fehlgeschlagen.",
      dictationFinalizing: "Diktat wird abgeschlossen…",
      dictationFinalizationTimedOut:
        "Das Diktat wurde gestoppt, bevor das letzte Teiltranskript fertiggestellt werden konnte.",
      dictationProviderUnavailable: "Für das Diktat ist kein Transkriptionsanbieter konfiguriert.",
      dictationRecording: "Aufnahme läuft {elapsed}",
