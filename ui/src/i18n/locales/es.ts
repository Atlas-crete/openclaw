...
export const es: TranslationMap = {
  ...
  sessionsView: {
    ...
    runFailedReason: "Error en la ejecución: {reason}",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint:
        "Las notificaciones se muestran de forma nativa por la aplicación OpenClaw en este Mac.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplicaciones complementarias para tu teléfono, reloj, escritorio y navegador, además de complementos para ampliar lo que puede hacer tu agente.",
  ...
  board: {
    ...
    widget: {
      ...
      appStaleTitle: "Esta aplicación anclada está obsoleta",
  ...
  chat: {
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess:
        "Se requiere acceso de escritura del operador para abrir esta discusión.",
