...
export const pt_BR: TranslationMap = {
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivityHint:
        "Mostre a atividade mais recente do assistente ou ferramenta abaixo das sessões em execução.",
    },
    connection: {
      title: "Conexão",
      gateway: "Gateway",
  ...
  custodian: {
    ...
    history: {
      ...
      opaqueChange:
        "Formatação ou comentários mudaram sem alterações visíveis nos caminhos de configuração.",
      sources: {
  ...
  labsPage: {
    intro:
      "O Labs contém recursos experimentais que podem mudar, falhar ou desaparecer entre versões.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      wearOs: {
        title: "Wear OS",
        desc: "O aplicativo complementar Android estende o OpenClaw ao seu relógio.",
      },
      macos: {
        title: "macOS",
        desc: "Aplicativo complementar na barra de menus para o seu Gateway — notificações, aprovações e chat rápido.",
      },
      windows: {
        title: "Windows",
        desc: "O aplicativo complementar para Windows conecta seu PC como um nó OpenClaw.",
      },
      linux: {
        title: "Linux",
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "Widget do painel: {title}. Use as setas para navegar. Mantenha Alt pressionado e use uma seta para movê-lo.",
      ...
      errorDetail: "O problema está contido a este card.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "A troca de ramificação requer acesso de operador admin.",
    ...
    board: {
      ...
      resizeDock: "Redimensionar painel do chat",
      reopenChat: "Mostrar chat",
      defaultTab: "Principal",
      mockPlaceholder: "Junção da visualização em quadro · {tabs} abas · {widgets} widgets",
      mockOverview: "Visão geral",
      mockResearch: "Pesquisa",
      mockSessionStatus: "Status da thread",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Mantenha o botão do microfone pressionado no compositor, fale e solte para inserir o texto sem enviar.",
