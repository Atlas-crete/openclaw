...
export const fr: TranslationMap = {
  ...
  sessionsView: {
    ...
    attentionRequired: "La session nécessite une intervention",
    model: "Modèle",
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Aperçus de conversations et réponses rapides depuis votre poignet.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "Widget du tableau de bord : {title}. Utilisez les touches fléchées pour naviguer. Maintenez Alt et appuyez sur une flèche pour le déplacer.",
  ...
  chat: {
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Maintenez le bouton du microphone dans le champ de saisie, parlez, puis relâchez pour insérer le texte sans l'envoyer.",
      ...
      selectedCameraUnavailable:
        "La caméra sélectionnée n'est pas disponible. Choisissez une autre caméra ou le réglage système par défaut.",
